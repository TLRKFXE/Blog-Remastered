...
export default defineConfig({
  shortcuts: [
    ...
    ['nav-link', 'opacity-50 hover:opacity-100 transition-opacity duration-300 cursor-pointer'],
    ['prose-link', 'text-inherit border-b border-current border-opacity-20 hover:border-opacity-60 decoration-none transition-all duration-300'],
    ['icon-btn', 'inline-block cursor-pointer select-none opacity-50 transition-all duration-300 ease-in-out hover:opacity-100'],
